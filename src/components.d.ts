...
declare global {
    ...
    interface HTMLAppProfileImageElement extends Components.AppProfileImage, HTMLStencilElement {
    }
    var HTMLAppProfileImageElement: {
        prototype: HTMLAppProfileImageElement;
        new (): HTMLAppProfileImageElement;
    };
